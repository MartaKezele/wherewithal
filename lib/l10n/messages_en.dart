...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m1(min) => "The password must contain at least ${min} characters.";

  static m2(methods) => "Sign in using one of the following methods: ${methods}. Once signed in you can configure sign in with google account in the profile section.";

  static m3(minCharacters) => "The password must contain at least ${minCharacters} characters.";
  ...
  static Map<String, dynamic> _notInlinedMessages(_) => {
    ...
    'minCharacters': m0,
    'passwordCharactersRestrictionMsg': m1,
    'signInUsingMethods': m2,
    'weakPasswordErrorMsg': m3
  };
}
